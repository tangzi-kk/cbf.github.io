...
$.ajax({
    ...
    data: {
        key: 'MVABZ-DHR33-EVZ3S-OLWOZ-TORPV-6JBFC',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(106.54041, 29.40268, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
